...
```bash
git clone https://github.com/Dayesoro/string-analyzer-service.git
...
The server will run on `http://localhost:3005` (or the PORT you specified in .env)
...
│   ├── controllers/
│   │   └── stringController.js      # Business logic for all endpoints
│   ├── routes/
│   │   └── stringRoutes.js          # Route definitions
│   ├── models/
│   │   └── stringStore.js           # In-memory data storage
│   └── utils/
...
- **Port:** 3005 by default (configurable via `.env` file)
- **Framework:** Express.js v5.1.0
- **Environment Variables:** Managed with dotenv
- **ID Generation:** SHA-256 hash of the string value ensures uniqueness
- **URL Encoding:** Strings with spaces and special characters are automatically URL-encoded
